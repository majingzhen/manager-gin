...
// Author
func (sysRoleMenuService *SysRoleMenuService) Delete(id string) (err error) {
...
// Author
func (sysRoleMenuService *SysRoleMenuService) DeleteByIds(ids []string) (err error) {
...
// Author
func (sysRoleMenuService *SysRoleMenuService) Update(id string, sysRoleMenuView *view.SysRoleMenuView) (err error) {
...
// Author
func (sysRoleMenuService *SysRoleMenuService) Get(id string) (err error, sysRoleMenuView *view.SysRoleMenuView) {
