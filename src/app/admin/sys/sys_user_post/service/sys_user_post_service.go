...
// Author
func (sysUserPostService *SysUserPostService) Delete(id int) (err error) {
...
// Author
func (sysUserPostService *SysUserPostService) DeleteByIds(ids []int) (err error) {
...
// Author
func (sysUserPostService *SysUserPostService) Update(id int, sysUserPostView *view.SysUserPostView) (err error) {
...
// Author
func (sysUserPostService *SysUserPostService) Get(id int) (err error, sysUserPostView *view.SysUserPostView) {
