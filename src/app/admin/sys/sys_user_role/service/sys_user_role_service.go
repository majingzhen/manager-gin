...
// Author
func (sysUserRoleService *SysUserRoleService) Delete(id string) (err error) {
...
// Author
func (sysUserRoleService *SysUserRoleService) DeleteByIds(ids []string) (err error) {
...
// Author
func (sysUserRoleService *SysUserRoleService) Update(id string, sysUserRoleView *view.SysUserRoleView) (err error) {
...
// Author
func (sysUserRoleService *SysUserRoleService) Get(id string) (err error, sysUserRoleView *view.SysUserRoleView) {
