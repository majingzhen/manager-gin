...
// Author
func (sysDictTypeService *SysDictTypeService) Create(sysDictTypeView *view.SysDictTypeView) (err error) {
...
// Author
func (sysDictTypeService *SysDictTypeService) Delete(id string) (err error) {
...
// Author
func (sysDictTypeService *SysDictTypeService) DeleteByIds(ids []string) (err error) {
...
// Author
func (sysDictTypeService *SysDictTypeService) Update(id string, sysDictTypeView *view.SysDictTypeView) (err error) {
...
// Author
func (sysDictTypeService *SysDictTypeService) Get(id string) (err error, sysDictTypeView *view.SysDictTypeView) {
...
// Author
func (sysDictTypeService *SysDictTypeService) Find(info *common.PageInfoV2) (err error) {
	err1, sysDictTypes, total := sysDictTypeDao.Find(info)
	if err1 != nil {
		return err1
	}
	info.Total = total
