...
func (dao *SysRoleMenuDao) DeleteRoleMenuByRoleId(id string) error {
	return global.GOrmDao.Delete(&[]SysRoleMenu{}, "role_id = ?", id).Error
}

// CreateBatch 批量插入
func (dao *SysRoleMenuDao) CreateBatch(menus []SysRoleMenu) error {
...
func (dao *SysRoleMenuDao) DeleteRoleMenuByRoleIds(ids []string) error {
	return global.GOrmDao.Delete(&[]SysRoleMenu{}, "role_id in ?", ids).Error
}
