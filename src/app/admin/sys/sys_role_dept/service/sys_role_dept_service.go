...
// Author
func (sysRoleDeptService *SysRoleDeptService) Delete(id string) (err error) {
...
// Author
func (sysRoleDeptService *SysRoleDeptService) DeleteByIds(ids []string) (err error) {
...
// Author
func (sysRoleDeptService *SysRoleDeptService) Update(id string, sysRoleDeptView *view.SysRoleDeptView) (err error) {
...
// Author
func (sysRoleDeptService *SysRoleDeptService) Get(id string) (err error, sysRoleDeptView *view.SysRoleDeptView) {
