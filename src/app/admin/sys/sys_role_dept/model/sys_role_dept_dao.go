...
// Author
func (dao *SysRoleDeptDao) Delete(id string) (err error) {
...
// Author
func (dao *SysRoleDeptDao) DeleteByIds(ids []string) (err error) {
...
// Author
func (dao *SysRoleDeptDao) Get(id string) (err error, sysRoleDept *SysRoleDept) {
